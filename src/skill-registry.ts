 ...
 *
 * Optional overrides allow tests to point the scan at temp directories.
 * Production callers pass nothing.
 */
export function initSkillRegistry(opts?: {
  projectRoot?: string;
  ...
  const globalSkillsDir =
    opts?.globalSkillsDir ?? path.join(os.homedir(), '.claude', 'skills');
